      ...
      <div className="p-4 border-bottom d-flex justify-content-between align-items-center" style={{ borderColor: 'rgba(255,255,255,0.2)' }}>
        {!isCollapsed && (
          <div>
            ...
            <small className="text-light opacity-75">Your Shopping Destination</small>
          </div>
        )}
        <button 
      ...
      <div className="p-4">
        ...
        <div className="mb-4">
          ...
          >
            <div className={`d-flex align-items-center ${isCollapsed ? 'justify-content-center w-100' : ''}`}>
              <span className={isCollapsed ? '' : 'me-3'} style={{ fontSize: isCollapsed ? '1.8rem' : '1.2rem' }}>🏠</span>
          ...
          {isAuthenticated && (
            <>
              ...
              <Link 
                ...
                style={{ 
                  transition: 'all 0.3s ease',
                  backgroundColor: isActive('/orders') ? 'rgba(155, 89, 182, 0.8)' : 'transparent',
              ...
              >
                <div className={`d-flex align-items-center ${isCollapsed ? 'justify-content-center w-100' : ''}`}>
                  <span className={isCollapsed ? '' : 'me-3'} style={{ fontSize: isCollapsed ? '1.8rem' : '1.2rem' }}>📦</span>
                  {!isCollapsed && <span className="fw-medium">My Orders</span>}
                </div>
              </Link>
            </>
          )}
        ...
        {isAuthenticated && (
          <div className="mb-4">
            ...
            >
              <div className={`d-flex align-items-center ${isCollapsed ? 'justify-content-center w-100' : ''}`}>
                <span className={isCollapsed ? '' : 'me-3'} style={{ fontSize: isCollapsed ? '1.8rem' : '1.2rem' }}>🛠️</span>
