          ...
          <div className="dropdown">
            ...
            >
              <div className="rounded-circle d-flex align-items-center justify-content-center me-2" 
                   style={{ width: '45px', height: '45px', fontSize: '1.2rem', background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)', color: 'white', boxShadow: '0 4px 15px rgba(102, 126, 234, 0.3)' }}>
                👤
              </div>
            ...
            <ul className={`dropdown-menu dropdown-menu-end ${dropdownOpen ? 'show' : ''}`} style={{ position: 'absolute', right: 0, top: '100%' }}>
              ...
              <li><button className="dropdown-item" onClick={() => { navigate('/wishlist'); setDropdownOpen(false); }}>❤️ My Wishlist</button></li>
              <li><hr className="dropdown-divider" /></li>
