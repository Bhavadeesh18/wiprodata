        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-lg-6">
              ...
              <p className="lead mb-4">Discover amazing products at unbeatable prices. Your one-stop shop for everything you need!</p>
              <div className="d-flex gap-3">
                <span className="badge bg-light text-dark px-3 py-2">
                  <i className="fas fa-shipping-fast me-2"></i>Free Shipping
                </span>
                <span className="badge bg-light text-dark px-3 py-2">
                  <i className="fas fa-undo me-2"></i>Easy Returns
                </span>
                <span className="badge bg-light text-dark px-3 py-2">
            ...
            <div className="col-lg-6 text-center">
              <div className="hero-stats">
                <div className="row">
                  ...
                  <div className="col-4">
                    <div className="stat-card">
                      <h3 className="fw-bold">{categories.length || 0}+</h3>
          ...
          <div className="row g-3">
            ...
            <div className="col-lg-4 col-md-3">
              ...
              <div className="d-flex gap-2 flex-wrap">
                <button 
                  className={`btn btn-sm ${priceRange.min === '' && priceRange.max === '50' ? 'btn-primary' : 'btn-outline-primary'}`}
                  onClick={() => setPriceRange({min: '', max: '50'})}
                >
                  Under $50
                </button>
                <button 
                  className={`btn btn-sm ${priceRange.min === '50' && priceRange.max === '200' ? 'btn-primary' : 'btn-outline-primary'}`}
                  onClick={() => setPriceRange({min: '50', max: '200'})}
                >
                  $50-$200
                </button>
                <button 
                  className={`btn btn-sm ${priceRange.min === '200' && priceRange.max === '' ? 'btn-primary' : 'btn-outline-primary'}`}
            ...
            <div className="col-12">
              <div className="text-center py-5">
                ...
                {(searchTerm || selectedCategory) && (
                  ...
                  >
                    <i className="fas fa-th me-2"></i>Browse All Products
                  </button>
                )}
              </div>
            </div>
