...
GO
----A trigger is a special kind of stored procedure that automatically runs (or "fires") in response to specific
...
Insert into Student(sno,nam,sub1,sub2,sub3) values(4,'Bhanu',66,72,62) 
GO
